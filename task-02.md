Here’s a beginner-friendly **Microsoft Word task** that involves using both the **Home tab** and **Insert tab** features. This task is designed to help users practice common formatting and insertion functions.
